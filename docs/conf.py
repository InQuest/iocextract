...
htmlhelp_basename = 'iocextractdoc'
...
latex_documents = [
    (master_doc, 'iocextract.tex', u'iocextract Documentation',
...
man_pages = [
    (master_doc, 'iocextract', u'iocextract Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'iocextract', u'iocextract Documentation',
     author, 'iocextract', 'Advanced Indicator of Compromise (IOC) extractor.',
     'Miscellaneous'),
]
